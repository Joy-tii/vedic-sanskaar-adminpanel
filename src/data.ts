...
// Example mock implementation of getUserActivities returning sample activities for a user
export async function getUserActivities(userId: string) {
  // You may fetch data from API or database here, this is sample static data
  return [
    {
      id: 'activity1',
      name: 'Participated in Vedic Ceremony',
      date: '2025-01-15',
      desc: 'Performed pooja rituals and helped organize event',
      remarks: 'Excellent involvement',
    },
    {
      id: 'activity2',
      name: 'Donated to Sanskaar Trust',
      date: '2025-04-02',
      desc: 'Charity donation for community development',
      remarks: 'Very generous',
    },
    // ... add more activity objects as needed
  ]
}

// Find and return one user by id from users list
